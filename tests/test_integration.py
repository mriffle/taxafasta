...
def test_basic_bacteria_filter(
    tmp_path: Path,
    data_dir: Path,
...
def test_basic_bacteria_filter_entry_count(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_merged_taxid_included(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_warning_deduplication_in_log(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_unparseable_header_in_log(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_accuracy_exact_root_matches(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_accuracy_sibling_not_matched(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_accuracy_parent_not_matched(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_accuracy_merged_outside_subtree(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_exit_code_success_no_warnings(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
...
def test_exit_code_with_warnings(
    tmp_path: Path,
    data_dir: Path,
    tiny_taxdump_dir: Path,
) -> None:
